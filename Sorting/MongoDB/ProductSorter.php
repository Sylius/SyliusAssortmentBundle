...
namespace Sylius\Bundle\AssortmentBundle\Sorting\MongoDB;
...
class ProductSorter extends ContainerAware implements SorterInterface
{
    ...
    public function sort($sortable)
    {
        if (!$sortable instanceof QueryBuilder) {
            throw new InvalidArgumentException('Default sorter supports only "Doctrine\\ODM\\MongoDB\\QueryBuilder" as sortable argument.');
        }
        ...
        /** @var QueryBuilder */
        $sortable->sort($sortProperty, $sortOrder);
    }
